...
export default function Service() {
  return (
    <>
      <div className="mx-auto sm:px-6 lg:py-28 bg-lighter w-full">
        <div className="lg:max-w-full lg:px-8">
          <p className="text-base font-normal mb-1">Our Services</p>
          <h2 className="text-4xl font-semibold text-gray-900">
            We Provide What You Need
          </h2>

          <div
            className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-2 md:grid-cols-3"
          ...
          >
            ...
            >
              ...
              <p className="text-center font-normal text-gray-600 mb-4 p-4">
            ...
            >
              ...
              <p className="text-center font-normal text-gray-600 mb-4 p-2">
                Create visual branding with amazing result, you just sit back
                and relax
              </p>
            </a>
